...
const TopClassCard = ({ item }) => {
  const { name, title, enroll, photo, price, description, _id } = item || {};

  return (
    <div
    className="card h-[500px] py-5 bg-base-100 border"
    >
      <figure className="p-5">
        <img
          className="h-44 w-full  lg:w-11/12 mx-auto lg:rounded-md"
      ...
      <div className="card-body -mt-6">
        ...
        <div className="card-actions justify-between">
          <p className="bg-[#6DC5D1] btn  text-white">
            Total Enroll:{" "}
            <span className="text-xl font-bold text-black">{enroll}</span>
          </p>
